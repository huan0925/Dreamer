        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item">
                <a href="post.php">
                <img src="images/plus.jpg" class='iconnotice'>
                </a>
              </li>
              <li class="nav-item">
            ...
            <form class="form-inline my-2 my-lg-0" method="post">
              <input type="text" name="search" class="form-control mr-sm-2 input-jq-toggle" type="search" placeholder="搜尋" aria-label="Search" style="width:780px; border-radius: 30px;">
              <input type="submit" name="submit" class="btn btn-outline-success my-2 my-sm-0" type="submit">
            </form> 
             <li class="nav-item">
             ...
             <a href="user.php"><i class="fas fa-user" style="color: #777; font-size: 30px; margin-top: 6px;margin-left: 10px;"></i></a>
  ...
  <div class="masonry">
    <div class ="item">
      <div class="solo">
        ...
        <a class="info" href="dreamerImage1.html" style="display: block;">
          <div class="share">
          ...
          <!-- <a href="#"><img src="images/save.jpg" class="icon" style=" width: 35px; height: 35px; position: absolute; top: 280px; left: 275px;" title="儲存"></a> -->
        </a>
      </div>
    </div>
   ...
   <!-- <div class ="item">
     <div class="solo">
      <img src="https://picsum.photos/360/520?random=11">
      <i class="far fa-heart" aria-hidden="true" style="font-size: 28px;"></i>
      <div class="info"> 
        <div class="share">
          <i title="facebook" class="fab fa-facebook-f"></i>
    ...
    <div class ="item">
     <div class="solo">
      <img src="https://picsum.photos/360/480?random=12">
      <i class="far fa-heart" aria-hidden="true" style="font-size: 28px;"></i>
      <div class="info"> 
        <div class="share">
            <i title="facebook" class="fab fa-facebook-f"></i>
    ...
    <div class ="item">
     <div class="solo">
      <img src="https://picsum.photos/360/560?random=13">
      <i class="far fa-heart" aria-hidden="true" style="font-size: 28px;"></i>
      <div class="info"> 
        <div class="share">
            <i title="facebook" class="fab fa-facebook-f"></i>
    ...
    <div class ="item">
     <div class="solo">
      <img src="https://picsum.photos/360/450?random=14">
      <i class="far fa-heart" aria-hidden="true" style="font-size: 28px;"></i>
      <div class="info"> 
          <div class="share">
            <i title="facebook" class="fab fa-facebook-f"></i>
