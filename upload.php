...
<html lang="en">
  ...
  <form method="post" enctype="multipart/form-data">
    <div class="form">
      ...
      <br>
      <div>
        <button name="sub" type="submit" class="btn btn-info">提交</button>
      </div>
      <?php
        if(isset($_POST['sub'])){
            ...
            if(strlen($title) > 40){
              ...
              if($end_time<$start_time){
                ...
                if(strlen($title) >= 1){
                  ...
                  $insert = "insert into post (user_id,title,goal,sponsor_total,start_date,end_date,content,post_image,proj_name,proj_email,proj_phone,viewers) values ('$user_id','$title','$goal','0','$start_time','$end_time','$content','$upload_image.$random_number','$principle_name','$principle_email','$principle_phone','0')";
                  //echo $insert;
